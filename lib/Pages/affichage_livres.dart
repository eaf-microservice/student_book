...
class BooksA1 extends StatelessWidget {
  const BooksA1({Key? key}) : super(key: key);
        ...
        body: Directionality(
          ...
          child: ListView(
            ...
            children: [
              ...
              Livre('التجويد \n كتاب البداية في علم التجويد', '1d_bnsJCZIst7x8lqxS-L6HUZwM-I2N6U',
                  'couvreBooks/Annee1/tajwid.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('الحديث \n كتاب عمدة الأحكام من كلام خير الأنام',
                  '1X9b0iMudnwrcNWF6qwNYJnjgUNp3mBTM', 'couvreBooks/Annee1/hadith.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('اللغة العربية \n كتاب المختصر في النحو', '1z4QKW7FH1Rua5a2a0XBSjWzwo5lVIOp4',
                  'couvreBooks/Annee1/arabic.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('الفقه \n كتاب التوثيق لبداية المتفقه', '1PRJElbM5j4tJgiRPWbHJwbWLDLty5OnU',
                  'couvreBooks/Annee1/fiqh.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('أصول الفقه\n كتاب غاية المأمول في شرح البداية في الأصول',
                  '1Ya8dGLkyLHHeY2cLb3ipi1ajLE5195vd', 'couvreBooks/Annee1/osol_fiqh.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre(
              ...
              Livre('مصطلح الحديث \n كتاب متن البداية في مصطلح الحديث',
                  '1tb1DGFD8yL7qeRy9JmLWHwYg6YBtK208', 'couvreBooks/Annee1/mostala7_7adit.png'),
            ],
          ),
        ) //
        );
...
class BooksA2 extends StatelessWidget {
  const BooksA2({Key? key}) : super(key: key);
        ...
        body: Directionality(
          ...
          child: ListView(
            ...
            children: [
              ...
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('اللغة العربية الفصل الثاني \n كتاب شرح البداية في الصرف',
                  '1U-HBkF0g9E2HSp2XThbu_lA27Zgq93g0', 'couvreBooks/Annee2/arabic_sarf.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('التربية والسلوك \n كتاب البداية في علم الرقائق',
                  '1bSqoG9Egc_EtPHHQleqGJupGujfv002f', 'couvreBooks/Annee2/tarbiya_w_solok.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('العقيدة \n كتاب حصول المنة بشرح أصول السنة للإمام أحمد',
                  '1yNeQoFOspB2AY__wCvqgBeyjcoC_7DxE', 'couvreBooks/Annee2/akida.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('التفسير \n كتاب تفسير القرآن العظيم للحافظ ابن كثير',
                  '1yNeQoFOspB2AY__wCvqgBeyjcoC_7DxE', 'couvreBooks/Annee2/tafsir.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre(
              ...
              Livre('الفقه المالكي \n كتاب الكافي في فقه أهل المدينة المالكي',
                  '1-1HXlfAdaeWeDuaYBUcDfr3-N6FbJbms', 'couvreBooks/Annee2/fiqh_maliki.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('الفقه الشافعي \n كتاب الإقناع في حل ألفاظ أبي شجاع',
                  '1iko2MaH2TOXAtv2jX1dAohX2B84EnBV4', 'couvreBooks/Annee2/fiqh_chafi3i.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('الفقه الحنفي \n كتاب اللباب في شرح الكتاب',
                  '1CpR7PBZF6rLGEaj2J-wEZmvUTIp7hqz1', 'couvreBooks/Annee2/fiqh_hanafi.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre(
...
class BooksA3 extends StatelessWidget {
  const BooksA3({Key? key}) : super(key: key);
        ...
        body: Directionality(
          ...
          child: ListView(
            ...
            children: [
              ...
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('الفقه الشافعي \n كتاب الإقناع في حل ألفاظ أبي شجاع',
                  '1iko2MaH2TOXAtv2jX1dAohX2B84EnBV4', 'couvreBooks/Annee3/fiqh_chafi3i.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('الفقه الحنفي \n كتاب اللباب في شرح الكتاب',
                  '1CpR7PBZF6rLGEaj2J-wEZmvUTIp7hqz1', 'couvreBooks/Annee3/fiqh_hanafi.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('العقيدة 1 \n كتاب الجامع لمسائل العقيدة الطحاوية',
                  '1zlcTNaRBIhdj5jZmbWv1NiZc_YLpwnhi', 'couvreBooks/Annee3/akida_ta7awiya.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('العقيدة 2 \n كتاب الجامع لمسائل العقيدة الواسطية',
                  '1A6mJOTKp6A8qMTv9vPMNb-JpzM-ikvQS', 'couvreBooks/Annee3/akida_wastiya.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('فقه عام \n كتاب الإبداع في شرح الإجماع', '1fjgfKo671xrURVfnD8w00CYkIy2m6qoJ',
                  'couvreBooks/Annee3/char7_ijma3.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('مصطلح الحديث \n كتاب نزهة النظر في توضيح نخبة الفكر',
                  '1bJltTVdRalOazdG2fpiWYtdema09ymyR', 'couvreBooks/Annee3/nozhat_nadar.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre(
              ...
              Livre('التفسير \n كتاب نيل المرام من تفسير آيات الأحكام',
                  '1fufXcH1K833JV1Mb4WMiQ9COiLMwmwhq', 'couvreBooks/Annee3/tafsir_ayat.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('التجويد \n كتاب السلسبيل الشافي في تجويد القرآن',
                  '1MoJ91cp7VKEAg9EdTWyPswrxfjMVSijM', 'couvreBooks/Annee3/salsabil_chafi.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre(
              ...
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre('اللغة العربية 1 \n كتاب الإعراب التطبيقي لجزء عم',
                  '1gu1YHy9mOYawTNdGv2V2kmN31WnuIeQS', 'couvreBooks/Annee3/i3rab_3ama.png'),
              Padding(padding: EdgeInsets.only(top: 10.0)),
              Livre(' اللغة العربية 2 \n كتاب ضوابط الكتابة الصحيحة',
                  '1xNpfXHo7hGa5ZZLCbmprTLHP5dQAyQPj', 'couvreBooks/Annee3/dawabit_kitaba.png'),
              /* Padding(padding: EdgeInsets.only(top: 10.0)),
...
class BooksA4 extends StatelessWidget {
  const BooksA4({Key? key}) : super(key: key);
    ...
    return Scaffold(
        ...
        body: Directionality(
          ...
          child: ListView(
            padding: EdgeInsets.all(20.0),
            children: [
              Livre('رابط الجوجل درايف \n كتب الفرقة الرابعة', 'https://drive.google.com/drive/folders/1nGnKs94v-1vfKv5Qal-TkQPbW5B4wDfv', 'images/titre.jpg'),
            ],
          ),
        ) //
        );
